...
class Smtp {
  ...
  /* Constractor */ 
  function __construct($relay_host, $smtp_port, $user, $pass) {
    $this->helo = 'sending HELO command';
    $this->debug = FALSE; 
  ...
  function sendmail($to, $from, $subject, $body) {
    ...
    $header .= !empty($additional_headers) ? $additional_headers : ''; 
    $header .= "Date: ".date("r")."\r\n"; 
    ...
    foreach ($TO as $rcpt_to) {
      ...
      if ($this->smtp_send($rcpt_to, $header, $body)) {
