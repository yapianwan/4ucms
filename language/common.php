...
$_lang[COM_RST_PSD]['email_body'] = '尊敬的用户，您好！<br><p>您可以通过如下链接，重置密码：<br><a href="[system_domain]/user.php?act=psw_reset&u_email=[u_email]&rand=[randstr]#main" target="_blank">点击该链接进行密码重置</a></p>';
$_lang['admin_'.COM_RST_PSD][COM_EM_SUBJ] = '[system_name]-密码已重置 您可以通过正文中的查看密码';
$_lang['admin_'.COM_RST_PSD]['email_body'] = '尊敬的用户，您好！<br><p>您的密码已重置为：[u_psw]<br>请您及时的登陆您的账号并修改密码</p>';
