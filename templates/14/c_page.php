...
<div id="wrapper" class="fitvids">
  ...
  <div class="content"><!-- Content Section -->
    <div class="container">
      <div class="row">
        <?php
        if ($channel['c_ifslideshow']) {
          $arr_slideshow = explode('|', $channel['c_slideshow']);
          ...
          foreach ($arr_slideshow as $val) {
            echo '<li><img alt="'.$channel['c_name'].'" class="img-responsive" src="'.$val.'" /></li>';
          }
          echo '</ul></div></div></div>';
        }
        ?>
        ...
        <div class="col-lg-9 col-sm-8 blog-post-contents">
          <div class="blog-post"><!-- Blog Post -->
            <h3><?php echo $channel['c_name'];?></h3>
            <div class="post-materials  clearfix"></div>
            <div class="post-content margint10"><?php echo $channel['c_content'];?></div>
          </div>
        </div>
