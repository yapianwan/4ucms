...
Dim extStr, imageExtStr, flashExtStr, flvExtStr, mediaExtStr, fileExtStr
...
If isEmpty(dirName) Then
	dirName = "image"
End If
If instr(lcase("image,flash,flv,media,file"), dirName) < 1 Then
	showError("目录名不正确。")
End If

Select Case dirName
	Case "flash" extStr = flashExtStr
	Case "flv" extStr = flvExtStr
