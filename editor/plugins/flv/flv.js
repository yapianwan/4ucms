...
KindEditor.plugin('flv', function (K) {
    var self = this, name = 'flv', lang = self.lang(name + '.'),
		...
		flvPath = self.pluginsPath + 'flv/swf/',
            ...
            var dialog = self.createDialog({
                ...
                yesBtn: {
                    ...
                    click: function (e) {
                        ...
                        //删除修改flv是增加的str字符
                        var str = flvPath + 'Flvplayer.swf?vcastr_file=';
                        if (url.indexOf(str) >= 0) {
                            var last = url.substring(url.indexOf(str) + str.length, url.length);
                            url = last;
                        }
                        var html = K.mediaImg(self.themesPath + 'common/blank.gif', {
                            src: flvPath + 'Flvplayer.swf?vcastr_file=' + url+(autostartBox[0].checked ? '&IsAutoPlay=1' : '&IsAutoPlay=0'),
